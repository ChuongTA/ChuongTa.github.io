...
<figure style="display: block; margin: 1.5em auto; text-align: center;">
  ...
  <figcaption style="margin-top: 0.5em; font-size: 0.9em; color: var(--global-text-color-light);"><strong>Figure 1.</strong> Graphical abstract: the hybrid state estimation and RL decision loop for smart heat pump operation (AI-generated by Gemini).</figcaption>
</figure>

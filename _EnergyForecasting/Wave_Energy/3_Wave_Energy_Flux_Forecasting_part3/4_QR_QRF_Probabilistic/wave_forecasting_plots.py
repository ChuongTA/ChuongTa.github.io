"""
Plotting functions for the wave-energy QR / QRF walk-forward pipeline.
Structurally identical to the electricity-price QR/QRF plotting module,
generalized for two targets (swh/Hs, mwp/Te) instead of one price series.
"""
import os
import numpy as np
import matplotlib
